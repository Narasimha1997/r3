...
QEMU_ARGS="-enable-kvm -cpu host,x2apic=off, -m 2G -M pc -monitor stdio --serial file:serial.out -drive file=$STORAGE_DISK,format=raw,index=1,media=disk -net  nic,model=rtl8139"
